...
<div v-show="activeTab==='profile'" id="profile" class="flex flex-col w-full my-2">
    <div class="flex flex-col lg:flex-row w-full mt-2">
        <div class="w-full lg:w-1/2 flex flex-col lg:mr-2 px-4 mt-2">
            <x-section.title text="profil" />
            <div class="w-full bg-white rounded shadow-md border border-gray-400">
                <div class="flex flex-col flex-grow py-3">
                    ...
                    <div class="w-full flex-grow-0">
                        <div class="flex justify-center py-3 text-sm">
                            <button class="flex items-center bg-indigo-100 text-indigo-500 font-medium border-b-2 border-indigo-500 px-3 py-2 hover:border-indigo-600 hover:bg-indigo-500 focus:underline-none focus:shadow-outline hover:text-gray-100 rounded-t shadow-md transition duration-500" @click="openModal('edit-profile-modal')">
                                <span>
                                    Editează
                                </span>
        ...
        <div class="w-full lg:w-1/2 flex flex-col px-4 mt-2">
            <div class="w-full flex flex-row items-center">
                <h3 class="py-3 text-gray-700 leading-relaxed font-medium text-base tracking-wider uppercase">Adresa</h3>
                <div class="w-full mx-2 border-b border-gray-400 translate-y-1/2"></div>
            </div>
            <div class="w-full bg-white rounded shadow-md border border-gray-400">
    ...
    <div class="flex flex-col lg:flex-row w-full mt-2">
        <div class="w-full lg:w-1/2 flex flex-col lg:mr-2 px-4 mt-2">
            <div class="w-full flex flex-row items-center">
                <h3 class="py-3 text-gray-700 leading-relaxed font-medium text-base tracking-wider uppercase">Parola</h3>
                <div class="w-full mx-2 border-b border-gray-400 translate-y-1/2"></div>
            </div>
            <div class="w-full bg-white rounded shadow-md border border-gray-400">
                <div class="flex flex-col flex-grow py-3">
