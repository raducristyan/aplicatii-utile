...
<div class="flex flex-wrap">
    <div class="flex flex-col bg-white m-2 px-20 py-6 border rounded-lg border-gray-400 shadow hover:border-red-500 hover:shadow-md transition-4">
        <div class="flex items-center justify-center mx-auto w-24 h-24 my-2 p-4 bg-red-300 border-2 border-red-500 shadow-md rounded-full">
            <svg aria-hidden="true" focusable="false" class="w-12 h-12 fill-current text-gray-300" viewBox="0 0 640 512">
