...
<div class="flex flex-wrap">
    <div class="flex flex-col bg-orange-300 m-2 px-12 py-6 border rounded-lg border-gray-400 shadow hover:border-orange-500 hover:shadow-md transition-4 opacity-75">
