@admin
<div v-show="activeTab === 'users'" class="px-4 py-3 my-4 bg-white" id="users">
    <div class="flex justify-center py-3">
        <button class="flex items-center bg-indigo-500 text-gray-200 text-semibold px-4 py-2 hover:bg-indigo-600 focus:underline-none focus:shadow-outline border-indigo-700 border-b-4 rounded-sm shadow" @click="openModal('new-user-modal')">
        ...
        <tbody>
            ...
            <tr class="items-center hover:bg-gray-100 border-b border-grey-400">
                ...
                <td class="py-3 px-3 align-middle">
                    <svg aria-hidden="true" focusable="false" @click="openModal('edit-user-modal')" class="w-5 h-5 fill-current text-gray-700 mr-2 hover:text-indigo-600 mr-2 cursor-pointer inline-block" viewBox="0 0 512 512">
                    ...
                    <svg aria-hidden="true" focusable="false" @click="openModal('delete-user-modal')" class="w-5 h-5 fill-current text-gray-700 hover:text-orange-600 cursor-pointer inline-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
