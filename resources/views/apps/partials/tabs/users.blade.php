@admin
<div v-show="activeTab === 'users'" class="p-4 my-6 bg-white rounded shadow-md border border-gray-400" id="users">
    <div class="flex justify-center py-3">
        <button class="flex items-center bg-indigo-500 text-gray-200 text-semibold px-4 py-2 hover:bg-indigo-700 focus:underline-none focus:shadow-outline border-indigo-800 border-b-4 rounded-t shadow transition duration-300" @click="openModal('new-user-modal')">
