@admin
<div v-show="activeTab === 'users'" class="px-4 py-3 my-6 bg-white" id="users">
        ...
        <tbody>
            ...
            <tr class="items-center hover:bg-gray-100 border-b border-grey-400">
                ...
                <td class="py-3 px-3 align-middle">
                    <svg aria-hidden="true" focusable="false" v-on:click="getUserToEdit({{ $user }})" @click="openModal('edit-user-modal')" class="w-5 h-5 fill-current text-gray-500 mr-2 hover:text-teal-600 mr-2 cursor-pointer inline-block" viewBox="0 0 640 512">
