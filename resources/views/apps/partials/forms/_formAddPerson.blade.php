    <div class="form-group" :class="{'has-error': person.name.hasError && !formAddPerson.isEmpty}">

        {!! Form::label('name', 'Nume', ['class' => 'col-md-3 control-label', 'for' => 'name']) !!}
        <div class="col-md-8">
    ...
    <div class="form-group" :class="{'has-error': person.cnp.hasError && !formAddPerson.isEmpty}">

        {!! Form::label('cnp', 'CNP', ['class' => 'col-md-3 control-label', 'for' => 'cnp']) !!}
        <div class="col-md-8">
    ...
    <div class="form-group" :class="{'has-error': person.email.hasError && !formAddPerson.isEmpty}">
    ...
    <div class="form-group">
        ...
        {!! Form::label('phone', 'Telefon', ['class' => 'col-md-3 control-label', 'for' => 'phone']) !!}
        <div class="col-md-8">
    ...
    <div class="form-group" :class="{'has-error': county.hasError && !formAddPerson.isEmpty}">
    ...
    <div class="form-group" :class="{'has-error': person.street.hasError && !formAddPerson.isEmpty}">
    ...
    <div class="form-group" :class="{'has-error': person.postalCode.hasError && !formAddCompany.isEmpty}">
