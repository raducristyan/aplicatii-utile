<form class="flex flex-col w-5/6 mx-auto">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <div class="relative">
            <select class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" name="county" v-model="selectedCounty" @change="getCities">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <div class="relative">
            <select class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" name="city" v-model="selectedCity" @change="getVillages">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <div class="relative">
            <select class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" name="village" v-model="address.village_id">
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-3/4 mt-2 mr-1">
            ...
            <input type="text" name="street" class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" :class="{'border-orange-500': errors.street}" v-model="address.data.street">
        ...
        <div class="flex flex-col w-1/4 mt-2 ml-1">
            ...
            <input type="text" name="number" class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" :class="{'border-orange-500': errors.number}" v-model="address.data.number">
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-1/2 mt-2 mr-1">
            ...
            <input type="text" name="bl" class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" :class="{'border-orange-500': errors.bl}" v-model="address.data.bl">
        ...
        <div class="flex flex-col w-1/2 mt-2 ml-1">
            ...
            <input type="text" name="sc" class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" :class="{'border-orange-500': errors.sc}" v-model="address.data.sc">
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-1/2 mt-2 mr-1">
            ...
            <input type="text" name="ap" class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" :class="{'border-orange-500': errors.ap}" v-model="address.data.ap">
        ...
        <div class="flex flex-col w-1/2 mt-2 ml-1">
            ...
            <input type="text" name="postal_code" class="w-full bg-gray-100 border-b-2 border-gray-400 text-gray-800 font-normal p-2 my-2 focus:border-b-2 focus:border-indigo-500 focus:outline-none focus:bg-gray-200 rounded-t shadow-md transition-4" :class="{'border-orange-500': errors.postal_code}" v-model="address.data.postal_code">
