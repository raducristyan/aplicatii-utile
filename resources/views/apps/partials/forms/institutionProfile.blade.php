<form class="flex flex-col w-5/6 mx-auto">
    <div class="flex flex-col w-full mt-2">
        ...
        <small class="w-full font-normal text-sm text-orange-500" v-text="errors.email"></small>
    </div>
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <small class="w-full font-normal text-sm text-orange-500" v-text="errors.name"></small>
    </div>
    <div class="flex flex-col w-full mt-2">
        ...
        <small class="w-full font-normal text-sm text-orange-500" v-text="errors.cif"></small>
    </div>
    <div class="flex flex-row">
        ...
        <div class="flex flex-col w-full mt-2 ml-1">
            ...
            <small class="w-full font-normal text-sm text-orange-500" v-text="errors.fax"></small>
        </div>
    </div>
    <div class="flex flex-col w-full mt-2">
        ...
        <small class="w-full font-normal text-sm text-orange-500" v-text="errors.bank"></small>
    </div>
    <div class="flex flex-col w-full mt-2">
        ...
        <small class="w-full font-normal text-sm text-orange-500" v-text="errors.iban"></small>
    </div>
</form>