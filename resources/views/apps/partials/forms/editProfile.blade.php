<form class="flex flex-col w-5/6 mx-auto">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <input type="email" class="w-full bg-gray-100 border border-gray-100 text-gray-800 font-normal p-2 my-2 focus:outline-none rounded-sm shadow-md" :class="{'border-orange-500': errors.email}" v-model="profile.email" id="profile_email" placeholder="Adresa de email" readonly>
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <input type="text" id="profile_last_name" class="w-full bg-gray-200 border border-gray-200 text-gray-800 font-normal p-2 my-2 focus:border focus:border-indigo-500 focus:outline-none focus:bg-white rounded-sm shadow-lg" :class="{'border-orange-500': errors.last_name}" v-model="profile.last_name" placeholder="Numele utilizatorului">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <input type="text" id="profile_job" class="w-full bg-gray-200 border border-gray-200 text-gray-800 font-normal p-2 my-2 focus:border focus:border-indigo-500 focus:outline-none focus:bg-white rounded-sm shadow-lg" :class="{'border-orange-500': errors.job}" v-model="profile.job" placeholder="Funcția utilizatorului">
