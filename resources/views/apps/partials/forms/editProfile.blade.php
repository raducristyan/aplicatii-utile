<form class="flex flex-col w-5/6 mx-auto">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <input type="email" class="w-full bg-gray-200  text-gray-800 font-normal p-2 my-2 focus:outline-none rounded-t shadow" :class="{'border-orange-500': errors.email}" v-model="profile.email" id="profile_email" readonly>
