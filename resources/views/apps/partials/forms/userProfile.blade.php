<form class="">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" :class="{'is-invalid': errors.first_name}" id="user_first_name" aria-describedby="userFirstNameHelp" v-model="address.first_name">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" :class="{'is-invalid': errors.last_name}" id="user_last_name" aria-describedby="userLastNameHelp" v-model="address.last_name">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" :class="{'is-invalid': errors.job}" id="user_job" aria-describedby="userJobHelp" v-model="address.job">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" :class="{'is-invalid': errors.mobile}" id="user_mobile" aria-describedby="userMobileHelp" v-model="address.mobile">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" :class="{'is-invalid': errors.phone}" id="user_phone" aria-describedby="userPhoneHelp" placeholder="Introduceți numărul telefonului" v-model="address.phone">
