<form class="flex flex-col w-5/6 mx-auto">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <input type="email" class="w-full bg-gray-100 text-gray-800 font-normal p-2 my-2 border border-transparent focus:border focus:border-indigo-500 focus:outline-none rounded" :class="{'border-orange-500': errors.email}" v-model="newUser.email" id="new_user_email" placeholder="Adresa de email">
    </div>
    <div class="flex flex-col w-full mt-2">
        <label for="new_user_first_name" class="block font-semibold text-gray-700">Prenume</label>
        <input type="text" id="new_user_first_name" class="w-full bg-gray-100 text-gray-800 font-normal p-2 my-2 border border-transparent focus:border focus:border-indigo-500 focus:outline-none rounded" :class="{'border-orange-500': errors.first_name}" v-model="newUser.first_name" placeholder="Prenumele utilizatorului">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <input type="text" id="new_user_last_name" class="w-full bg-gray-100 text-gray-800 font-normal p-2 my-2 border border-transparent focus:border focus:border-indigo-500 focus:outline-none rounded" :class="{'border-orange-500': errors.last_name}" v-model="newUser.last_name" placeholder="Numele utilizatorului">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <small class="w-full font-normal text-sm text-orange-500" v-text="errors.password"></small>
    </div>
    <div class="flex flex-col w-full mt-2">
