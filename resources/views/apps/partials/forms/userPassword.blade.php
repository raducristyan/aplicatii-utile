<form class="flex flex-col w-5/6 mx-auto">
    ...
    <div class="flex flex-col w-full mt-2">
        ...
        <small class="w-full font-normal text-sm text-orange-500" v-text="errors.old_password"></small>
    </div>
    <div class="flex flex-col w-full mt-2">
        ...
        <small class="w-full font-normal text-sm text-orange-500" v-text="errors.new_password"></small>
    </div>
    <div class="flex flex-col w-full mt-2">
