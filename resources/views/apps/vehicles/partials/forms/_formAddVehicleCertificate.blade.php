    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <div class="col-md-10 col-md-offset-3">
                {!! Form::reset("Resetează", ['class' => 'btn btn-warning']) !!} {!! Form::submit("Adaugă", ['class' => 'btn btn-success'])
                !!}
            </div>
        </div>
...
@include('apps.partials.modals._modalAddPerson') @include('apps.partials.modals._modalAddCompany') @include('apps.vehicles.partials.modals._modalAddCategory')