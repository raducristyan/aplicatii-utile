...
<form class="" id="loginform" method="POST" action="{{ route('password.update') }}">
    ...
    <div class="flex items-center mt-4">
        ...
        <input id="password" class="w-full bg-transparent border-b-2 border-purple-400 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none {{ $errors->has('email') ? ' border-b-2 border-red-600' : '' }}" type="password" name="password" required="required" placeholder="Introduceți noua parolă">
    </div>
    ...
    <div class="flex items-center mt-4 w-full">
        ...
        <input id="password_confirmation" class="w-full bg-transparent border-b-2 border-purple-400 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none {{ $errors->has('email') ? ' border-b-2 border-red-600' : '' }}" type="password" name="password_confirmation" required="required" placeholder="Confirmați parola">
    </div>
