...
<form class="" id="loginform" method="POST" action="{{ route('register') }}">
    ...
    <div class="flex flex-wrap items-center mt-4">
        <div class="flex items-center w-full">
            ...
            <input id="institution" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition duration-300 {{ $errors->has('institution') ? ' border-orange-600' : 'border-purple-400' }}" name="institution" type="institution" required="required" placeholder="Denumirea instituției" value="{{ old('institution')}}">
    ...
    <div class="flex flex-wrap items-center mt-4">
        <div class="flex items-center w-full">
            ...
            <input id="cif" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition duration-300 {{ $errors->has('cif') ? ' border-orange-600' : 'border-purple-400' }}" name="cif" type="text" required="required" placeholder="Codul fiscal" value="{{ old('cif')}}">
        </div>
        @if ($errors->has('cif'))
        <div class="text-sm font-normal text-orange-600 w-full mt-1">
            {{ $errors->first('cif') }}
    ...
    <div class="flex flex-wrap items-center mt-4">
        <div class="flex items-center w-full">
            ...
            <input id="email" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition duration-300 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" name="email" type="email" required="required" placeholder="Introduceți adresa de email" value="{{ old('email')}}">
        </div>
        @if ($errors->has('email'))
        <div class="text-sm font-normal text-orange-600 w-full mt-1">
            {{ $errors->first('email') }}
    ...
    <div class="flex flex-col md:flex-row">
        <div class="flex items-center mt-4 w-full md:w-1/2">
            ...
            <input id="first_name" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition duration-300 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" type="text" name="first_name" required="required" placeholder="Numele" value="{{ old('first_name')}}">
        ...
        <div class="flex items-center mt-4 w-full md:w-1/2">
            ...
            <input id="last_name" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition duration-300 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" type="text" name="last_name" required="required" placeholder="Prenumele" value="{{ old('last_name')}}">
    ...
    <div class="flex flex-wrap flex-col md:flex-row">
        <div class="flex flex-wrap items-center mt-4 w-full md:w-1/2">
            <div class="flex items-center w-full">
                ...
                <input type="password" name="password" id="password" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition duration-300 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" required="required" placeholder="Introduceți parola">
            </div>
        </div>
        <div class="flex items-center mt-4 w-full md:w-1/2">
            ...
            <input type="password" name="password_confirmation" id="password_confirmation" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition duration-300 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" required="required" placeholder="Confirmați parola">
        </div>
    ...
    <div class="flex items-center my-8">
        <div class="w-2/3 mx-auto">
            <button class="w-full border-2 border-orange-500  py-3 rounded-full text-indigo-700 font-bold text-lg focus:outline-none focus:shadow-outline hover:text-gray-200 hover:bg-indigo-500 hover:border-indigo-700 hover:shadow-lg transition duration-300" type="submit">Creează contul</button>
        </div>
    </div>
