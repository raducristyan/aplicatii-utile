...
<form class="" id="loginform" method="POST" action="{{ route('register') }}">
    ...
    <div class="flex flex-wrap items-center mt-4">
        <div class="flex items-center w-full">
            ...
            <input id="institution" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition-4 {{ $errors->has('institution') ? ' border-orange-600' : 'border-purple-400' }}" name="institution" type="institution" required="required" placeholder="Denumirea instituției" value="{{ old('institution')}}">
    ...
    <div class="flex flex-wrap items-center mt-4">
        <div class="flex items-center w-full">
            ...
            <input id="cif" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition-4 {{ $errors->has('cif') ? ' border-orange-600' : 'border-purple-400' }}" name="cif" type="text" required="required" placeholder="Codul fiscal" value="{{ old('cif')}}">
        </div>
        @if ($errors->has('cif'))
        <div class="text-sm font-normal text-orange-600 w-full mt-1">
            {{ $errors->first('cif') }}
    ...
    <div class="flex flex-col md:flex-row">
        <div class="flex items-center mt-4 w-full md:w-1/2">
            ...
            <input id="first_name" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition-4 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" type="text" name="first_name" required="required" placeholder="Numele" value="{{ old('first_name')}}">
        ...
        <div class="flex items-center mt-4 w-full md:w-1/2">
            ...
            <input id="last_name" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition-4 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" type="text" name="last_name" required="required" placeholder="Prenumele" value="{{ old('last_name')}}">
    ...
    <div class="flex flex-wrap flex-col md:flex-row">
        <div class="flex flex-wrap items-center mt-4 w-full md:w-1/2">
            <div class="flex items-center w-full">
                ...
                <input type="password" name="password" id="password" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition-4 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" required="required" placeholder="Introduceți parola">
            </div>
        </div>
        <div class="flex items-center mt-4 w-full md:w-1/2">
            ...
            <input type="password" name="password_confirmation" id="password_confirmation" class="w-full bg-transparent border-b-2 focus:border-gray-300 px-2 py-3 text-gray-200 font-normal outline-none transition-4 {{ $errors->has('email') ? ' border-orange-600' : 'border-purple-400' }}" required="required" placeholder="Confirmați parola">
        </div>
        ...
        <div class="w-full flex items-center justify-between">
            <div class="flex items-center">
                <label for="signup" class="relative cursor-pointer checkbox">
                    <input id="signup" type="checkbox" class="absolute w-0 h-0 opacity-0  transition-4">
