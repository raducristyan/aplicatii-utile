...
var vm = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        ...
        getCities: function getCities() {
            ...
            axios.post('/api/county/cities', { 'county_id': this.county }).then(function (data) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getVillages: function getVillages() {
      ...
      console.log("working");
      axios.post("/api/city/villages", { city_id: this.selectedCity }).then(function (data) {
        console.log("data");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateProfile: function updateProfile() {
      axios.put("/api/user/profile", this.forms.userProfile).then(function (response) {
