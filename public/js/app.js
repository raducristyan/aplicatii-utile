...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('user-profile-view', __webpack_require__(35));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('user-password-view', __webpack_require__(38));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('address-view', __webpack_require__(41));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('village-view', __webpack_require__(10));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__getVillage__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__getVillage___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__getVillage__);
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: { getVillage: __WEBPACK_IMPORTED_MODULE_0__getVillage___default.a },
  data: function data() {
    return {
      county: "",
      countyCities: "",
  ...
  methods: {
    ...
    updateAddress: function updateAddress() {
      axios.put("/apps/user/address", this.forms.address).then(function (response) {
        window.location.href = "/dashboard";
        console.log(response);
      }).catch(function (error) {
        console.log(error);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getVillages: function getVillages() {
      ...
      console.log("working");
      axios.post("/apps/city/villages", { city_id: this.selectedCity }).then(function (data) {
        console.log("data");
        _this.cityVillages = data.data;
      }).catch(function (error) {
        console.log(error);
      });
    },
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "form-group col-md-6" }, [
      _c("label", { staticClass: "col-sm-12" }, [_vm._v("Localitatea (UAT)")]),
      _vm._v(" "),
      _c("div", [
        _c(
          "select",
      ...
      _c("div", [
        _c(
          ...
          _vm._l(_vm.cityVillages, function(village) {
            return _c("option", { domProps: { value: village.id } }, [
