...
window.util = __webpack_require__(34);

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('address-view', __webpack_require__(35));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('user-profile-view', __webpack_require__(38));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('user-password-view', __webpack_require__(41));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('institution-profile-view', __webpack_require__(44));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-21a2c3e6", Component.options)
  } else {
    hotAPI.reload("data-v-21a2c3e6", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateAddress: function updateAddress() {
      axios.put(this.forms.url, this.forms.address).then(function (response) {
    ...
    getCities: function getCities() {
      ...
      axios.post("/apps/county/cities", { county_id: this.county }).then(function (data) {
    ...
    getVillages: function getVillages() {
      ...
      axios.post("/apps/city/villages", { city_id: this.city }).then(function (data) {
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.forms.address.village_id,
                              expression: "forms.address.village_id"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { name: "village" },
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.forms.address.street,
                          expression: "forms.address.street"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", name: "street" },
                      domProps: { value: _vm.forms.address.street },
                      on: {
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.forms.address.number,
                          expression: "forms.address.number"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", name: "number" },
                      domProps: { value: _vm.forms.address.number },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.forms.address.bl,
                          expression: "forms.address.bl"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", name: "bl" },
                      domProps: { value: _vm.forms.address.bl },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.forms.address, "bl", $event.target.value)
                        }
                      }
                    })
                  ]),
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.forms.address.sc,
                          expression: "forms.address.sc"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", name: "sc" },
                      domProps: { value: _vm.forms.address.sc },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.forms.address, "sc", $event.target.value)
                        }
                      }
                    })
                  ])
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.forms.address.ap,
                          expression: "forms.address.ap"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", name: "ap" },
                      domProps: { value: _vm.forms.address.ap },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.forms.address, "ap", $event.target.value)
                        }
                      }
                    })
                  ]),
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.forms.address.postal_code,
                          expression: "forms.address.postal_code"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", name: "postal_code" },
                      domProps: { value: _vm.forms.address.postal_code },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-21a2c3e6", module.exports)
  }
}
